...
int main(int argc, char* argv[])
{
...

    {
        ...
        std::cout << std::setw(20) << std::left << "Default Constructor "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
                  << " - a.size = " << a.size() << std::endl;

        begin = std::chrono::high_resolution_clock::now();
        w2::Text b(argv[1]);
        end = std::chrono::high_resolution_clock::now();
        std::cout << std::setw(20) << std::left << "Custom Constructor "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
        ...
        std::cout << std::setw(20) << std::left << "Copy Assignment "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
                  << " - a.size = " << a.size() << std::endl;
        ...
        std::cout << std::setw(20) << std::left << "Move Assignment "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
                  << " - a.size = " << a.size() << std::endl;
        ...
        std::cout << std::setw(20) << std::left << "Copy Constructor "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
        ...
        std::cout  << std::setw(20) << std::left << "Move Constructor "
                  << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
    ...
    std::cout << std::setw(20) << std::left << "Destructor "
              << std::setw(10) << std::right << TIMEP(begin, end) << " nanoseconds"
              << std::endl;
